...
export function ParticipantFlow({ id }: { id: string }) {
  ...
  return (
    <main id="main" className="container">
      <Link href={`/surveys/${id}`} className="back-link">
        <Arrow back />
        Survey details
      </Link>
      <div className="page-heading">
        <div>
          <h1>Your voice. Just your voice.</h1>
          <p>{survey.title}</p>
        </div>
      </div>
      <div className="detail-grid">
        <div className="stack">
          ...
          {completed ? (
            ...
            <div className="notice">
              {status === "Scheduled"
                ? "This survey hasn’t started yet."
            ...
            <>
              <section className="panel">
                <div className="step-label">01 / ELIGIBILITY</div>
                <h2>A little proof, no introduction.</h2>
                <p className="small muted" style={{ marginBottom: 22 }}>
                  {survey.eligibility}
                </p>
                <div className="field">
                  <label htmlFor="outcome">Development scenario</label>
                  <select
                    id="outcome"
                    value={outcome}
                    disabled={verifying}
                  ...
                  >
                    <option value="eligible">Eligible participant</option>
                    <option value="ineligible">Not eligible participant</option>
                  </select>
                  <p className="hint">
                    You control this outcome. No identity, credential, or
                    cryptographic proof is checked.
                  </p>
                </div>
                <button
                  type="button"
                ...
                {eligibility && (
                  <div
                    role="status"
                    className={
                      eligibility.state === "eligible" ? "notice" : "error"
                    }
                    style={{ marginTop: 18, marginBottom: 0 }}
                  >
                    {eligibility.state === "eligible"
                      ? "Eligibility: Verified (demo only). You can try the response form."
                      : `Not eligible. ${eligibility.reason}`}
                  </div>
                )}
              </section>
              <section className="panel">
                <div className="step-label">02 / YOUR RESPONSE</div>
                ...
                <form onSubmit={submit}>
                  <div className="field">
                    <label htmlFor="response">Private response</label>
                    <textarea
                      id="response"
                      value={response}
                      ...
                      maxLength={2000}
                      rows={6}
                      placeholder="Share your perspective. Please don’t include personal or sensitive information."
        ...
        <aside className="panel" style={{ alignSelf: "start" }}>
            ...
            <li>
              ...
              <div>
                ...
                <span className="muted">
                  No identity fields in this journey.
                </span>
              </div>
            </li>
            <li>
              ...
              <div>
                ...
                <span className="muted">
                  A development adapter, not a real proof.
                </span>
              </div>
            </li>
            <li>
          ...
          <p className="small muted">
            Your browser and its extensions can read form data. Do not use this
            prototype for real sensitive feedback.
          </p>
        </aside>
      </div>
    </main>
